...
export default function SendAmount({
  ...
  const handleSend = async () => {
    ...
    // Convert amount to whole number (multiply by 1000000 and remove decimals)
    const amountInMicroUnits = Math.round(parseFloat(amount) * 1000000);
    ...
    try {
      ...
      // Store transaction data (keep original amount for display)
      addTransaction({
        hash: data.txHash,
